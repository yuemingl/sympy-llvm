...
plt.annotate('SymJava',        xy=(x[1]-0,      SymJava[1]    +0))
plt.annotate('C++_O3',         xy=(x[0]-0,      CPPO3[1]      -0.06))
plt.annotate('Sage',           xy=(x[2]+0.3,      sage[1]       -0))
plt.annotate('SymPy_ufuncify', xy=(x[3]-0,      ufuncify[3]   +2)       )
plt.annotate('SymPy_lambdify', xy=(x[0],         lambdify[1]    -0))
plt.annotate('Theano_vector',  xy=(x[0]+0.3,      theano_vec[1] +0.6))
plt.annotate('Theano_scalar',  xy=(x[1]-0,      theano[1]+10     -0))
plt.annotate('Matlab',         xy=(x[1]-0,      matlab[1]+10     -0))
plt.annotate('Mathematica',    xy=(x[0]-0,      mathematica[2]-0))
