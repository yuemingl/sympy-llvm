...
# i in range(1,10), reduce in range(0,i)
...
# i in  range(0, 10), reduce in range(0,i+1)
#vlen= 256 Time: compile= 0.730321884155 ,compute= 0.521997928619 ,total= 1.25231981277